...
function constructCalendar($time)
{
	...
	$timeoffirstday = mktime(0, 0, 0, $month, 1, 2016);
	...
	$timeoflastday = mktime(0, 0, 0, $month, $numdays, 2016);
	...
	echo "<tbody>";
	echo "<tr>";
	echo "<th colspan=\"7\" class=\"month title\"><a href =\"largecal.php\">" . $monthtext . " " .  $year  . "</a></th>";
	echo "</tr>";
	...
	{	
		...
		if($day == $dayofmonth)
		{
			...
			else if($eCount <=3 && $eCount >=1)
			{
				echo "<td id = \"today\" class = \"blue\">" . $day . "</td>";	
			}
			else
			{
	...
	for($i=2;$i<$numweeks;$i++)
	{
		...
		for($j=1;$j<8;$j++)
		{
			...
			if($day == $dayofmonth)
			{
				...
				{
					echo "<td id = \"today\" class = \"green\">" . $day . "</td>";	
				}
				else
				{
					echo "<td id = \"today\">" . $day . "</td>";
	...
	for($i=0;$i<7;$i++)
	{
		...
		if($day == $dayofmonth)
		{
			...
			else if($eCount <=3 && $eCount >=1 && $day >10)
			{
				echo "<td id = \"today\" class = \"green\">" . $day . "</td>";	
			}
			else
